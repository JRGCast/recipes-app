...
describe('21 - Exiba o menu inferior apenas nas telas indicadas pelo protótipo', () => {
  ...
  it('Não tem footer na tela de detalhes de uma receita de comida', () => {
    cy.visit('http://localhost:3000/recipes-app/comidas/52771');

    hasNoFooter();
  });

  it('Não tem footer na tela de detalhes de uma receita de bebida', () => {
    cy.visit('http://localhost:3000/recipes-app/bebidas/178319');

    hasNoFooter();
  });

  it('Não tem footer na tela de receita em processo de comida', () => {
    cy.visit('http://localhost:3000/recipes-app/comidas/52771/in-progress');

    hasNoFooter();
  });

  it('Não tem footer na tela de receita em processo de bebida', () => {
    cy.visit('http://localhost:3000/recipes-app/bebidas/178319/in-progress');

    hasNoFooter();
  });

  it('Tem footer na tela de explorar', () => {
    cy.visit('http://localhost:3000/recipes-app/explorar');

    hasFooter();
  });

  it('Tem footer na tela de explorar comidas', () => {
    cy.visit('http://localhost:3000/recipes-app/explorar/comidas');

    hasFooter();
  });

  it('Tem footer na tela de explorar bebidas', () => {
    cy.visit('http://localhost:3000/recipes-app/explorar/bebidas');

    hasFooter();
  });

  it('Tem footer na tela de explorar comidas por ingrediente', () => {
    cy.visit('http://localhost:3000/recipes-app/explorar/comidas/ingredientes');

    hasFooter();
  });

  it('Tem footer na tela de explorar bebidas por ingrediente', () => {
    cy.visit('http://localhost:3000/recipes-app/explorar/bebidas/ingredientes');
